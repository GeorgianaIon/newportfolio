...
const Home: NextPage = () => {
  ...
  const skillsArray: Skill[] = [
    {
      title: "Creative",
      image: "/images/skills-images/soft-skills/creativity.png",
    },
    {
      title: "Sociable",
      image: "/images/skills-images/soft-skills/talking.png",
    },
    {
      title: "Optimistic",
      image: "/images/skills-images/soft-skills/stay-positive.png",
    },
    {
      title: "Accountable",
      image: "/images/skills-images/soft-skills/daily-tasks.png",
    },
    {
      title: "Passioned",
      image: "/images/skills-images/soft-skills/quality-of-life.png",
    },
  ];
      ...
      >
        ...
        >
          {skillsArray.map(({ image, title }, index) => (
            <SkillCard key={index} skillImage={image} skillTitle={title} />
          ))}
        </Grid>
      </Grid>
    </>
