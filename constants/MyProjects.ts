...
export const myProjects: IProject[] = [
  ...
  },
  {
    ...
    pictures: ['/images/project-images/portofolio-1.png', '/images/project-images/portofolio-2.png'],
    description: Strings.portfolioDescription,
    techStack: [tech.React, tech.TypeScript],
    github: 'https://github.com/GeorgianaIon/newportfolio',
    demo: '',
    type: 'TABLET',
  },
];